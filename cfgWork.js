class ActiveModules {
    modules = ['LiquidSwap','AptoSwap','AnimeSwap','PancakeSwap','AuxSwap']
...
class OKX {
    ...
    withdraw_out_module = true; // хотим ли выводить аптос после прогона обратно на биржу

    amount_to_apt = [0.21, 0.22]; // количество аптоса на вывод
